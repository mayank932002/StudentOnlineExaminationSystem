...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Faculty Added</div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		if($object->row_count() > 0)
		{
			$error = '<div class="alert alert-danger">Faculty Email Already Exists</div>';
		}
		else
		{
			...
			$success = '<div class="alert alert-success">Faculty Details Updated</div>';
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Faculty Status change to '.$_POST['next_status'].'</div>';
	}
