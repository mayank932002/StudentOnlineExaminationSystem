...
if(!$object->is_login())
{
    header("location:".$object->base_url."admin1");
}

if(!$object->is_master_user())
{
    header("location:".$object->base_url."admin1/result.php");
}
...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Faculty Management</h1>
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Faculty Name <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Faculty Contact No. <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Faculty Email <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Faculty Password <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-md-4 text-right">Faculty Profile</label>
                            <div class="col-md-8">
